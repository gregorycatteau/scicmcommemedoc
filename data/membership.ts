...
const memberships: Record<string, MembershipOption[]> = {
  ...
  family: [
    ...
    },
    {
      ...
      title: "Famille Actionnaire de M Comme Médoc",
    ...
    },
    {
      ...
      title: "Devenez Famille Consom'Acteur",
  ...
  institution: [
    ...
    },
    {
      ...
      collegedescription: "Participez à des projets collaboratifs innovants avec M Comme Médoc. En tant que membre, votre institution a accès à des ressources partagées et peut co-créer des solutions avec d'autres partenaires de la SCIC. Cette adhésion est idéale pour les institutions souhaitant s'engager dans des initiatives de co-développement et de collaboration. Vous contribuez à des projets qui visent à améliorer la qualité de vie locale et à promouvoir des pratiques écologiques et sociales responsables, tout en renforçant la visibilité et l'impact de votre institution au sein de la communauté.",
      isactionnary: false,
      isactivemember: true,
      minactions: 10
    },
