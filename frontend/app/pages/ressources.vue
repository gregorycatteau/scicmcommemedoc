...
.DemoNotice {
  border: 1px solid rgb(185 104 63 / 0.2);
  @apply mx-auto max-w-7xl rounded-[2rem] bg-white/70 px-6 py-5 sm:px-8;
}
.DemoNotice strong {
  @apply text-lg font-black text-orange-800;
}
.DemoNotice p {
  @apply mt-2 leading-7 text-black/70;
}
.DemoNotice a {
  border: 1px solid rgb(185 104 63 / 0.25);
  @apply mt-4 inline-flex rounded-full px-5 py-2.5 font-bold text-black transition duration-500 hover:bg-black hover:text-white;
}
.ResourcesWorkspace {
...
.EditorialSection p {
  @apply mt-4 leading-7 text-black/70;
}
</style>
