<template>
  <MainWrapper>
    <BookLayout>
      <section class="AliasPage">
        <p>Preface</p>
        <h1>Pourquoi je suis ici</h1>
        <p>Cette entree conserve une adresse directe vers le texte fondateur du Livre.</p>
        <NuxtLink to="/livre/preface">Lire la preface</NuxtLink>
      </section>
    </BookLayout>
  </MainWrapper>
</template>
