<template>
  <header class="header">
    <h1 class="page-title">M Comme Médoc - Découvrez Nos Membres</h1>
  </header>
  <main class="main">
    <section class="section" v-for="item in content" :key="item.title">
      <figure class="image-container">
        <img :src="item.image" alt="" />
      </figure>
      <article class="content">
        <h2 class="section-title">{{ item.title }}</h2>
        <p class="description">Une description personnalisée pour chaque membre.</p>
      </article>
    </section>
  </main>
...
const content = [
  { title: "Myriam", image: "/Myriam.png" },
  { title: "Olivier", image: "/Olivier.png" },
  { title: "Marc", image: "/Marc.png" }
];
</script>
