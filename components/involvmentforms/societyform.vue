      ...
      <UForm :schema="schema" :state="state" class="schema">
        ...
        >
          <UInput
            ...
            placeholder="Par exemple : Initiative Médoc"
          />
        </UFormGroup>
        <UFormGroup label="Représentée par" name="username" eager-validation>
          <UInput
            v-model="state.username"
            placeholder="Par exemple : Jean Bourseau"
          />
        </UFormGroup>
        <UFormGroup
        ...
        >
          <UInput
            ...
            placeholder="Par exemple : Fabricant d'initiatives"
          />
        </UFormGroup>
        <UFormGroup label="Adresse" name="adressname" eager-validation>
          <UInput
            v-model="state.adressname"
            placeholder="Par exemple : 12 rue des Minguets"
          />
        </UFormGroup>
        ...
        <UFormGroup label="Email" name="email" eager-validation>
          <UInput
            v-model="state.email"
            placeholder="Par exemple : jean.bourseau@example.com"
          />
        </UFormGroup>
