...
<template>
  <UForm :schema="schema" :state="state" class="schema">
    <UFormGroup label="Nom de l'association" name="associationName" eager-validation>
      <UInput v-model="state.associationName" placeholder="Par exemple : Association XYZ" />
    </UFormGroup>
...
const schema = z.object({
  associationName: z.string().min(2, 'Doit contenir au moins 2 caractères'),
